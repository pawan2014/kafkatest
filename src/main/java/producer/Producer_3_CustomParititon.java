...
public class Producer_3_CustomParititon {
    private final Logger mLogger = LoggerFactory.getLogger(Producer_3_CustomParititon.class);
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        props.setProperty("speed.sensor.name", "test name");
        props.put("partitioner.class", "paritioner.StockPartitioner");
    ...
    public static ShareInputAvro getEOF(){
        ShareInputAvro  p = new ShareInputAvro();
        p.setTranscationId("EOF");
